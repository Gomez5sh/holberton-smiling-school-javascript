...
function make_filterv(data) {
  ...
  for (let person of data.courses) {
    ...
    for (let i = 0; i < onstarts; ++i) {
      div +=
        '<img class="mcard__starts" src="./Images/images/star_on.png" alt="Starts"></img>';
    }
    ...
    for (let i = 0; i < offstarts; ++i) {
      div +=
        '<img class="mcard__starts" src="./Images/images/star_off.png" alt="Starts">';
    }
